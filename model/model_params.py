...
print(f"Kp = {(conversion[300]-conversion[199])/(qc[300]-qc[199])}")

print(f"y2 (300) = {conversion[300]}")
print(f"y1 (199) = {conversion[199]}")

print(f"u2 (300) = {qc[300]}")
print(f"u1 (199) = {qc[199]}")

y632_val = 0.632*(conversion[300]-conversion[199]) + conversion[199]
print(f"y0.632 = {y632_val}")
y632 = np.ones(601)*y632_val

plt.figure()
plt.subplot(2, 1, 1)
plt.plot(t[100:400], conversion[100:400], label="Conversion of A")
plt.plot(t[100:400], y632[100:400], label="y0.632")
plt.xlabel("Time (min)")
